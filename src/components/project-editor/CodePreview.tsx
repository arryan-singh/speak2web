...
const CodePreview: React.FC<CodePreviewProps> = ({ code, language, fileName }) => {
  return (
    <Card className="p-4 mb-5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 shadow-md">
      <div className="flex justify-between items-center mb-3">
        <span className="text-sm font-medium text-gray-700 dark:text-gray-200">{fileName}</span>
        <span className="text-xs bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-gray-700 dark:text-gray-200 border dark:border-gray-600">
          {language}
        </span>
      </div>
