...
export const ThemeToggle = () => {
  ...
  return (
    <div className="flex items-center gap-2 p-3 rounded-full bg-gray-100 dark:bg-gray-800 border dark:border-gray-500 transition-colors shadow-sm px-[5px] py-[7px]">
